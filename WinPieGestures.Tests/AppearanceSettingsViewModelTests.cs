...
public sealed class AppearanceSettingsViewModelTests
{
        ...
        Create(AppConfig? config = null, ILocalizationService? localization = null)
    {
        ...
        var interfaceTheme = new InterfaceThemeSettingsViewModel(configService, messenger, loc);
        var vm = new AppearanceSettingsViewModel(configService, dialogs, messenger, profileList, loc, interfaceTheme);
