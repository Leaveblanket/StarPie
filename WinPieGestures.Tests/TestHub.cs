...
/// <summary>
/// 落盘/导入消息记录器（测试基建）：注册在测试专用 WeakReferenceMessenger 上，
/// 供页面 ViewModel 测试断言"发过哪些落盘请求/导入广播"。
/// </summary>
public sealed class SaveSpy
{
    /// <summary>收到的立即落盘请求数。</summary>
    public int Immediate;

    /// <summary>收到的防抖落盘请求数。</summary>
...
/// <summary>
/// IActionExecutorService 的测试替身：不执行真实动作，仅记录请求，
/// 供槽位"测试动作"命令的编排断言。
/// </summary>
