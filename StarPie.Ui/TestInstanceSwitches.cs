...
namespace StarPie
{
    ...
    /// <see cref="MouseButton"/> 的第 n 个按键（n 取 1–5），供 e2e 以鼠标侧键驱动手势链路。
    /// </summary>
    /// <remarks>
    ...
    /// XBUTTON1／XBUTTON2）作 e2e 观察面的价值：未被抑制时不弹出上下文菜单，手势链路的外部观测
    ...
    public static class TestInstanceSwitches
    {
        ...
        /// <see cref="DefaultButton"/>。合法范围为 Button1–Button5（NoButton 不构成手势）。
        /// </summary>
