...
{
    public ObservableCollection<SidebarNavigationDesignTimeItem> NavigationItems { get; } = new()
    {
        ...
        new() { AutomationId = "NavPage2", Title = "⚡ 轮盘与动作", IconData = IconWheelGesture },
        new() { AutomationId = "NavPage3", Title = "⚙️ 高级与系统", IconData = IconAdvanced },
    };

    // 图标 Path Data 与 HostPageContributor/SystemIntegrationContributor/WheelGestureContributor 一致。
...
/// <summary>侧边栏导航项设计期样例条目（形状对齐运行时 NavigationItemViewModel 绑定面）。</summary>
public sealed class SidebarNavigationDesignTimeItem
{
