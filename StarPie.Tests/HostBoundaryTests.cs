...
public sealed class HostBoundaryTests
{
    ...
    private static readonly Type[] KernelTypes =
    {
        ...
        typeof(EmptyPluginReviewCatalog), typeof(PluginReviewOutcome), typeof(PluginReviewDecision),
        typeof(SignedPluginReviewCatalog), typeof(IPluginSignatureVerifier),
        typeof(PluginSignatureStatus), typeof(PluginSignatureCheck), typeof(WinTrustSignatureVerifier),
        typeof(PluginAdmissionPolicy), typeof(PluginDeveloperModeService),
