...
namespace WinPieGestures
{
    ...
    public sealed class DialogService : IDialogService
    {
        ...
        {
            var window = new ProgramPickerWindow(this) { Owner = _owner };
            ...
            Func<string, (bool IsValid, string ErrorMessage)>? validator = null)
        {
            ...
            var dialog = new InputDialog(title, prompt, defaultText, validator) { Owner = _owner };
        ...
        {
            var picker = new IconPickerWindow(currentIconKey) { Owner = _owner };
        ...
        {
            var dialog = new ColorPickerWindow(initialHex) { Owner = _owner };
