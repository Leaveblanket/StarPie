namespace StarPie.PluginRuntime.Loading
{
    ...
    /// 框架判定按 <c>System</c>/<c>System.*</c> 前缀 + 若干基础程序集 + WPF 桌面程序集名，
    /// 与全仓「平台程序集」判定同口径但不误伤 <c>SystemFoo</c> 这类同前缀私有程序集；
    ...
    public static class PluginSharedAssemblyPolicy
    {
        ...
        /// <summary>不随插件包分发、由运行时提供的框架程序集名（<c>System</c>/<c>System.*</c> 之外的例外项）。</summary>
        ...
        /// <param name="assemblyName">程序集简单名；null 或空串返回 false。</param>
        /// <returns>true 表示由默认 ALC 统一解析（SDK 共享契约或框架程序集）。</returns>
