...
namespace StarPie.Modules
{
    ...
    /// 页面（高级与系统 / 关于与更新）写入 <see cref="NavigationCatalog"/>（槽位/标题键/图标/
    ...
    {
        /// <summary>向导航目录注册本模块页面（槽位：3 高级与系统、4 关于与更新）。</summary>
        ...
        /// <summary>
        /// 注册本模块页面 VM（容器单例）：高级与系统页/关于页。工厂经 ServiceProvider
        /// 惰性解析共享内核件（配置/对话框/本地化/消息与 AppHostDelegates）；开机自启/提权探测/
        /// 更新日志打开等本模块内静态行为在此接线，VM 保持委托注入可测。
        /// </summary>
